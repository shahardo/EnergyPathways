...
function SheetContent({
  ...
  /** Logical, not physical -- `dir` mirrors this in RTL (SPEC §8, CLAUDE.md). */
  side?: "start" | "end" | "top" | "bottom";
}) {
  const sideClassName: Record<typeof side, string> = {
    end: "inset-y-0 end-0 h-full w-3/4 border-s data-[state=closed]:slide-out-to-end data-[state=open]:slide-in-from-end sm:max-w-2xl",
    start:
      "inset-y-0 start-0 h-full w-3/4 border-e data-[state=closed]:slide-out-to-start data-[state=open]:slide-in-from-start sm:max-w-2xl",
